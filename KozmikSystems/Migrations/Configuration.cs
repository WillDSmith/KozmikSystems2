    ...
    internal sealed class Configuration : DbMigrationsConfiguration<KozmikSystems.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(KozmikSystems.Models.ApplicationDbContext context)
        {
            context.Navbars.AddOrUpdate(
              ...
              new Navbar() { Id = 2, nameOption = "Users", imageClass = "fa fa-users fa-fw", status = true, isParent = true, parentId = 0 },
              new Navbar() { Id = 3, nameOption = "Add User", controller = "Users", action = "Create", status = true, isParent = false, parentId = 2 },
              new Navbar() { Id = 4, nameOption = "View All Users", controller = "Users", action = "Index", status = true, isParent = false, parentId = 2 }
            );
        }
    }
}
